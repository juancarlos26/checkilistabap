...
class bfRecordManagement{
    ...
    function getTableBar(){
        ...
        $out .= '<div id="bfAvailableFields">'.bf_alert('Column selection in full version, only', 'https://crosstec.org/en/extensions/joomla-forms-download.html').'</div>'."\n";
        $out .= '</div>';
        $out .= '</div>';
    ...
    function listRecords(){
        ...
        ?>
            <?php echo bf_alert('Get BreezingForms Full Version', 'https://crosstec.org/en/extensions/joomla-forms-download.html');?>
            <?php echo bf_alert('More features, no footers, no messages', 'https://crosstec.org/en/extensions/joomla-forms-download.html');?>
            <br />
